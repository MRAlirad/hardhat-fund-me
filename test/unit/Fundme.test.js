...
describe("FundMe", () => {
	...
	beforeEach(async () => {
		...
		// const accounts = await ethers.getSigners(); //! get different account

		deployer = (await getNamedAccounts()).deployer; //! the account we want to connect to FundMe
		await deployments.fixture(["all"]); //! run our entire deploy folder
